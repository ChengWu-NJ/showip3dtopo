...
var jgraph = (function () {
	...
	/** added to show ip on August 15, 2019 **/
	drawText: function ( graph ) {
		...
		material = new THREE.MeshPhongMaterial( {
                                 color: node.hasOwnProperty('color') ? node.color : self.defaultNodeColor
                           } );

		textgeometry = new THREE.TextGeometry(k, 
			      {
				size: 3, height: 0.9
			      });
		...
		mesh = new THREE.Mesh(textgeometry, material);
                ...
                //added to show ip on August 20, 2019
                if (node.hasOwnProperty('userdata')) {
                    mesh.userdata = node.userdata;
                }
            ...
            //added to show ip on August 20, 2019
            this.onNodeHover(this.onEnter, this.onExit);
        },
...
//            var geometry;
            ...
            $.each(graph.nodes, function (k, node) {
                ...
                //normalize faces and vertex
//                geometry = self.sphereGeometry;
...
//                mesh = new THREE.Mesh(geometry, material);
        ...
        /** added to show ip on August 20, 2019 **/
        onEnter: function (obj3d) {
	    obj3d.orig_color = obj3d.material.color.getHex();
            obj3d.material.color.setHex(0x0);
	},

        onExit: function (obj3d) {
            obj3d.material.color.setHex(obj3d.orig_color);
	},
...
//                material = new THREE[materialName]({color: new THREE.Color(color) });
                material = new THREE[materialName]({color: new THREE.Color(color) }); //precision: 'mediump'
            } else {
